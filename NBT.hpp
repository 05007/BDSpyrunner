...
struct StructureTemplate {
	...
	struct Tag* save() {
		Tag* t = 0;
		SYMCALL<Tag*>("?save@StructureTemplateData@@QEBA?AV?$unique_ptr@VCompoundTag@@U?$default_delete@VCompoundTag@@@std@@@std@@XZ", fill + 32, &t);
		return t;
	}
	/*
	void fillFromWorld(BlockSource* a2,BlockPos* a3,StructureSettings* a4) {
		SYMCALL("?fillFromWorld@StructureTemplate@@QEAAXAEAVBlockSource@@AEBVBlockPos@@AEBVStructureSettings@@@Z", this, a2, a3, a4);
	}*/
};
enum TagType {
